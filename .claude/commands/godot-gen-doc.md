...
3. **智能架构设计与Agent协调**：
   - **设计复杂度评估**: 根据主题 $1 和详细程度智能选择设计策略
     * **概要设计**: godot-architect + local-developer组合进行快速设计
     * **详细设计**: godot-architect + 相关专业agents协作
     * **游戏机制设计**: 增加godot-game-designer进行游戏设计
     * **技术特性设计**: 优先使用local-developer进行技术实现分析

   - **分层架构设计**:
     * **基础架构分析**: 使用Task工具启动godot-architect代理进行专业架构分析
       - 分析主题 $1 的技术架构需求和组件设计
       - 提供多种架构方案和技术选型建议
       - 输出标准化的架构设计文档
     * **技术可行性验证**: 对于详细设计，使用local-developer(qwen3-coder:30b)进行技术分析
       - 分析架构方案的Godot引擎实现可行性
       - 识别关键技术实现难点和解决方案
       - 提供具体的实现路径和代码结构建议
     * **游戏机制设计**: 如果涉及游戏机制，并行启动godot-game-designer
       - 设计游戏核心机制和用户体验流程
       - 提供美术风格和交互设计建议
       - 输出游戏设计方案文档
...
5. **智能文档生成与Agent协作**：
   - **文档生成策略**: 根据设计复杂度和类型选择生成方式
     * **概要文档**: design-doc-writer + local-developer协作生成
     * **详细文档**: design-doc-writer + 多专业agents协作
     * **技术文档**: 增加local-developer进行技术细节验证
     * **游戏设计文档**: 增加godot-game-designer进行游戏性验证
   ...
   - **分层文档生成**:
     * **主要文档生成**: 使用Task工具启动多个design-doc-writer代理并行生成专业文档
       ...
       - 要求包含所有必需章节和标准化格式
     * **技术实现验证**: 对于详细技术文档，使用local-developer进行技术验证
       - 验证文档中技术方案的可行性
       - 检查实现细节的准确性和完整性
       - 提供代码示例和实现建议
