...
3. **需求分析与方案设计**：
   - 使用Task工具启动godot-architect代理进行专业架构分析
   - 使用sequential-thinking工具深入分析主题 $1 的需求和目标
   - 通过tavily-mcp搜索相关的技术趋势和社区最佳实践
...
5. **文档生成与存储**：
   - 使用Task工具启动design-doc-writer代理生成专业文档
   - 使用filesystem工具创建文档目录结构
   - 根据用户选择的方案，按照 $2 的要求生成设计文档
   - 使用memory工具记录设计决策和关键架构信息
   - 使用Bash命令执行文档格式化和验证
