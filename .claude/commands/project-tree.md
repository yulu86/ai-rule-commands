---
name: project-tree
description: 生成项目目录结构的ASCII树并添加到CLAUDE.md中
argument-hint: [目录树最大深度]
---

智能项目目录结构生成工具

自动分析项目结构，生成美观的ASCII目录树，并将其添加到项目根目录的CLAUDE.md文件中。
...
- **CLAUDE.md集成**：自动将目录树添加到CLAUDE.md文件中
...
5. **CLAUDE.md更新**：将生成的目录树添加到CLAUDE.md文件中
...
- **权限问题**：处理文件权限不足的情况
- **CLAUDE.md缺失**：如果CLAUDE.md不存在，询问是否创建
- **文件锁定**：处理CLAUDE.md被其他程序占用的情况
