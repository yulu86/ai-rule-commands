    ...
    if args.format == 'json':
        ...
        if analysis.get('variables'):
            ...
            for var in analysis['variables']:
                ...
                onready_info = " [onready]" if var.get('is_onready') else ""
                print(f"  - {var['name']}{type_info}{value_info}{export_info}{onready_info} [行 {var['line_number']}]")
        ...
        if analysis.get('performance_notes'):
            ...
            for note in analysis['performance_notes']:
                severity = "[警告] " if note['severity'] == 'warning' else "[信息] "
